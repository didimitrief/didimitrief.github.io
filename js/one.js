...
function outArrayData(item, i, arr)
{
	...
	if (typeof(item)=="string"){
		if(i==0) 
			string += "<th colspan='2'><h1>" + item + " - ";
		else if (i==1) 
			string += item + "</h1></th>";
		else 
			string+= "<tr align='center'><td class='about'>"+about[i]+"</td><td class = 'in'>" + item + "</td></tr>";
	}
	else if (typeof(item)=="number"){
			string+= "<tr><td class = 'about'>"+about[i]+"</td><td class = 'in'>" + item + "</td></tr>";
		...
		if (!Array.isArray(item[0]))
		{
			if (data==0)
				...
				item.sort();
				item.reverse();
			string += "</table><table><tr><td class = 'about'>"+about[i] + "</td><td class = 'in'> " + item[0]+"</td></tr>";
			for(var j = 1; j<item.length; j++){
				string +="<tr><td></td>" + "<td class = 'in'>" + item[j] + "</td></tr>";
			}
			string += "</table>";
		}
		else
		{
			string+="<table><tr><td class = 'about'>"+about[i]+"</td>"+"<td class = 'in'>" + liter(item[0]) + "</td></tr>";
			for(var j = 1; j<item.length; j++){
				string+="<tr><td></td>" + "<td class = 'in'>" +liter(item[j]) + "</td></tr>";
			}
			string +="</table>";
		}
	...
	{
		string+="<table><tr><td class='about'>" + about[i] + "</td><tr>";
		for(j in item){
			string += "<td></td><td class='in'><b>"+j +"</b> - "+item[j]+"</td></tr>";
		}
		string+="</table>"
	}
	return string;
